...
export const isSameRow = (draggedItem: Employee, targetedItem: Employee) => {
...
export const getContentElement = (parent: HTMLElement): HTMLElement | null => {
  ...
  const selector = '.k-grid-content tbody tr';
  if (match(parent, selector)) {
    return parent;
  }
...
export const findDataItem = (data: Employee[], row: HTMLTableRowElement) => {
